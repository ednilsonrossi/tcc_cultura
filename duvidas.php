...
<a class="legend2" href="pontosCulturais.html"><small style="font-size: 15px; position: absolute; right: 1145px; top: 95px; color: #915c37;">Voltar</small><i class="uil uil-arrow-left" style="font-size: 35px; position: absolute; right: 1150px; top: 60px; color: #915c37;"></i></a>
...
<body>
    <section class="faq-container">
        ...
        <div class="faq">
            ...
            <div class="resposta">
                <p>Sim! Ao final da página Home existe um portal de dúvidas, na qual mandamos um email diretamente para você.</p>
            </div>
        </div>
    </section>
</body>
